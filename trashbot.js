...
const adminNovelTitles = [
    ...
    "Gennahara: An Explosion on My Heart",
    "Ian-kun! Another World War II Bonus Story!",
    "Darryl Wants to Make My Husband Happy Again",
    "Gennah's Contract with the Demon Lord",
    "Benjutsu no Taisen: Master of the Labyrinth",
    "Gennah the Rascal of the Holy Land",
    ...
    "Darryl Wants to Play with Your Mom!",
    "Gennah's Secret Diary of a Vampire Princess",
    "Katelyn's a Fool and a Bear! The Tale of the Sixteen",
    "Darryl: An Explosion on My Way to a Friend's Diner",
    "Darryl of the Mysterious Girl in Another World",
    "Trashbotcher's Knife, Part 2",
    "Drake is the Witch's Guide to Disaster Magic: A Tale of Ordinary Life",
    ...
    "Darryl and the Disappearance of a Fairy",
...
function randomizeAdmin(){
    db.pickTitles(adminNovelTitles, 6)
}
